...
urlpatterns = [
    ...
    url(r'^ticket/ticket_needpay_car/', view_tickets.ticket_needpay_car, name='ticket_needpay_car'),
    url(r'^ticket/ticket_needcollect_car/', view_tickets.ticket_needcollect_car, name='ticket_needcollect_car'),
