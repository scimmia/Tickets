...
urlpatterns = [
    ...
    url(r'^ticket/ticket_tocollect/', views.ticket_tocollect, name='ticket_tocollect'),
    # url(r'^ticket/ticket_createorder/', views.ticket_createorder, name='ticket_createorder'),
    url(r'^ticket/ticket_payorders/', views.ticket_payorders, name='ticket_payorders'),
    url(r'^ticket/ticket_payorder/(?P<pk>\d+)/$', views.ticket_payorder, name='ticket_payorder'),
    url(r'^ticket/ticket_sellorders/', views.ticket_sellorders, name='ticket_sellorders'),
    url(r'^ticket/ticket_sellorder/(?P<pk>\d+)/$', views.ticket_sellorder, name='ticket_sellorder'),
